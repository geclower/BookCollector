...
SECRET_KEY = 'django-insecure-i3xmo0!stp(+_u&u!ll8@@r%r$1@=4at5%&j23c7k!2+r%8g(('
...
DATABASES = {
    'default': {
        ...
        # 'USER': 'book_admin', <-- (optional) postgres user name, if you have to sign into an account to open psql, you will want to add that user name here.
